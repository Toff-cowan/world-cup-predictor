...
function tabClasses(active) {
  return active
    ? `${base} px-4 py-2 text-xs uppercase tracking-wide border bg-zinc-900 text-white border-zinc-900 dark:bg-white dark:text-zinc-900 dark:border-white focus-visible:ring-zinc-900 dark:focus-visible:ring-white`
    : `${base} px-4 py-2 text-xs uppercase tracking-wide border bg-white text-zinc-600 border-zinc-300 hover:border-zinc-900 dark:bg-zinc-900 dark:text-zinc-300 dark:border-zinc-600 dark:hover:border-white dark:hover:text-white focus-visible:ring-zinc-400`;
}
...
const variants = {
  ...
  link: `${base} text-sm font-semibold underline underline-offset-4 text-zinc-900 hover:text-zinc-600 dark:text-zinc-100 dark:hover:text-white bg-transparent px-0 py-0 min-h-0 focus-visible:ring-zinc-400`,
  ghost: `${base} text-xs uppercase tracking-wide text-zinc-700 hover:text-zinc-900 dark:text-zinc-300 dark:hover:text-white bg-transparent px-0 py-0 min-h-0`,
};
